	...
	<div class="login-box">
		...
		<div class="login-logo">
			<img
				...
				class="user-image" data-reactid=".0.0.0.1.4.0"> My Page
		...
		<div class="login-box-body">
			...
			<a href="/user/logout">로그아웃</a><br> <a href="/user/delete">질문과
				답변</a><br> <a href="/user/modify">내 계정 변경</a><br> <a
				href="/user/delete">내 계정 삭제</a><br>
